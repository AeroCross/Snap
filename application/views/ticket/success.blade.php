...
<div class="offset3 span6">
	...
	<p>Su número de consulta es el {{ HTML::link('ticket/' . $ticket->id, '#' . $ticket->id) }} — este es su número identificador para que pueda hacerle seguimiento luego mediante el {{ HTML::link('tickets', 'listado') }}.</p>
	...
	<div class="btn-group pagination-centered">
		...
		<a href="{{ URL::to('ticket/' . $ticket->id) }}" class="btn">{{ Helper::icon('mail-forward') }} Ir a Consulta</a>
